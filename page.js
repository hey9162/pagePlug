    ...
    $.extend($.tzPageRenderers.defaultRenderer.prototype, {
        ...
        createLink:function(page_id, current_page, appendopts){
            ...
            if(page_id == current_page){
                lnk = $("<button class='current tzui-tips'>" + appendopts.text + "</button>");
            }
            else
            {
                lnk = $("<button class='tzui-tips'>" + appendopts.text + "</button>")
        ...
        getLinks:function(current_page, eventHandler,psize) {
            ...
            if (interval.start > 0 && this.opts.num_edge_entries > 0)
            {
                ...
                {
                    var ellipse_span = jQuery("<button class='tmui-tips'>"+this.opts.ellipse_text+"</button>").appendTo(fragment);
                }
            }
            ...
            if (interval.end < np && this.opts.num_edge_entries > 0)
            {
                ...
                {
                    jQuery("<button class='tzui-tips'>"+this.opts.ellipse_text+"</button>").appendTo(fragment);
                }
            ...
            $('button', fragment).click(eventHandler);
            ...
            if(this.opts.showGo)fragment.append("<span href='javascript:void(0);'  style='float:left;'>共<label class='tmui_page_itemcount'>"+this.maxentries+"</label>条</span>&nbsp;<input type='text' title='请输入其他页码' class='tm_number' value='"+proxySzie+"' id='tm_pagego'/>&nbsp;<button href='javascript:void(0);' title='请输入其他页码' style='' class='tm_go'>GO</button>");
            return fragment;
